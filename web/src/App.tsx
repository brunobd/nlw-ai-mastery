...
export function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Header */}
      <div className="px-6 py-3 items-center flex justify-between border-b">
        ...
        <aside className="w-80 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <span className="block txt-xs text-muted-foreground italic">
            ...
            <div className="space-y-4">
              <Label>Temperatura <span className="text-muted-foreground">{temperature}</span></Label>
              <Slider
                min={0}
                max={1}
                step={0.1}
              ...
              />
              <span className="block txt-xs text-muted-foreground italic leading-relaxed">
